    ...
    "characters": [
        {
            ...
            "description": "The quick builder (straw house)",
            "type": "protagonist",
        ...
        },
        {
            ...
            "description": "The creative builder (wood house)",
            "type": "npc",
            "timestamp": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "description": "The careful builder (brick house)",
            "type": "npc",
            "timestamp": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "description": "The cunning antagonist",
            "type": "npc",
            "timestamp": datetime.now(timezone.utc).isoformat()
        }
    ],
